...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && !empty($_GET)) {
    $cliente['nombreCompleto'] = $_GET['nombreCompleto'] ?? '';
    $cliente['correoElectronico'] = $_GET['correoElectronico'] ?? '';
    $cliente['edad'] = $_GET['edad'] ?? '';
    $cliente['tipoLibro'] = $_GET['tipoLibro'] ?? '';
    $cliente['privacidad'] = $_GET['privacidad'] ?? '';
    ...
    $error['edad'] = (is_numeric($cliente['edad']) && $cliente['edad'] >= 13) ? '' : 'ERROR: Edad debe ser un número mayor o igual a 13.';
...
<?php if ($_SERVER['REQUEST_METHOD'] === 'GET' && !in_array('', $error, true)): ?>
